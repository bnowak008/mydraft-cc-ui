...
- Planning to implement dark mode support (tracked in `.cursor/todos/dark-mode.md`)
...
- **Dark Mode Implementation:** Planning to add comprehensive dark mode support using Ant Design's theme capabilities and CSS variables. The task is tracked in `.cursor/todos/dark-mode.md` with detailed steps and requirements.